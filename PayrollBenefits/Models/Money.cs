...
{
    /// <summary>
    /// Using this implementation based on Fowler "Patterns of Enterpise Application Architecture"
    /// This implementation is from:
    /// https://huntjason.wordpress.com/2006/02/02/moneycurrency-class-in-c-2-0/
    /// </summary>
    public sealed class Money : IEquatable<Money>, IComparable, IComparable<Money>
    {
        ...
        public static Money operator -(Money first, Money second)
        {
            ...
            var amount = first.Amount - second.Amount;

            return new Money(amount, first.EnglishCultureName);
